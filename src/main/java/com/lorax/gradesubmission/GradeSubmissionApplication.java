...
public class GradeSubmissionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Student[] students = new Student[] {
			new Student("Ahmed Fatthi", LocalDate.parse(("2003-09-06"))),
			new Student("LoRaX", LocalDate.parse(("1996-05-08"))),
			new Student("Muhammed", LocalDate.parse(("2000-01-01"))),
			new Student("MotherFucker", LocalDate.parse(("2002-02-02")))
		};
